            ...
            <Link
              ...
              className={cn(
                branch === config?.branch
                  ...
                  : "hover:bg-accent",
                "inline-flex items-center rounded-lg px-3 py-2 transition-colors ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
              )}
