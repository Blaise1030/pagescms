...
Content operations (create, rename, delete) still follow the repository configuration for each content entry. See [content.operations](/docs/configuration/content).
